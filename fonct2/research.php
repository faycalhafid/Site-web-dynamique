        ...
        if (isset($_POST['search-query'])){
            ...
            foreach ($key_words as $key){
                ...
                if (strlen($key)>2 and $key!="aux") {
                    ...
                    $sql="SELECT titre,id_recette FROM recettes WHERE titre LIKE '".$key."%' UNION
                          SELECT titre, id_recette FROM recettes WHERE titre LIKE '%".$key."'";
                    $arr=array();
                    ...
                    foreach ($result2 as $r){
                        ...
                        if (!in_array($id,$ids))
                        {
                            $sql3="SELECT titre FROM recettes WHERE id_recette=".$id;
